...
public class DisputeQueryService {
    ...
    public Map<String, Object> canCreateDispute(Long orderId, Long userId) {
        ...
        List<com.idleitems.school.module.order.entity.Order.OrderStatus> canDisputeStatuses = Arrays.asList(
                com.idleitems.school.module.order.entity.Order.OrderStatus.SHIPPED,
                com.idleitems.school.module.order.entity.Order.OrderStatus.COMPLETED,
                com.idleitems.school.module.order.entity.Order.OrderStatus.REFUND_REQUESTED
        );
